import { Instagram, Linkedin, LinkedinIcon, Mail, MapPin, Phone, Send, Twitter } from "lucide-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-6 justify-center">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:amritesh.raj61@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                                     amritesh.raj61@gmail.com
                                </a>
                            </div>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+918709137413" className="text-muted-foreground hover:text-primary transition-colors">
                                     +91 8709137413
                                </a>
                            </div>
                ...
                <div className="bg-card p-8 rounded-lg shadow-xs" onSubmit={handleSubmit}>
                    ...
                    <form className="space-y-6">
                        ...
                        <div>
                            <label htmlFor="message" className="block text-sm text bg-center font-medium mb-2"> Your Message</label>
                            <textarea
                                id="message"
                                required
